// Adaptado de src/lib/use-tv-channel.ts (raíz). Único cambio respecto al
// original: los imports (cliente supabase y protocolo locales en vez de los
// alias @/ del repo raíz). La lógica del canal —nombre `cinefilo:${id}`,
// eventos "command"/"state", presence keys "tv"/"control"— es byte-idéntica,
// porque tiene que emparejar con el /control ya desplegado.
